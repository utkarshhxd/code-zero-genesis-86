    ...
    <div className="relative overflow-hidden pt-16">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center">
        <h1 className="sm:text-5xl md:text-6xl font-extrabold font-josefin text-white text-4xl">
          <span className="align-middle" style={{fontFamily: 'inherit', fontSize: '0.8em', textTransform: 'capitalize'}}>Master</span>
          ...
          <span className="align-middle" style={{fontFamily: 'inherit', fontSize: '0.8em', textTransform: 'capitalize'}}>And</span>
